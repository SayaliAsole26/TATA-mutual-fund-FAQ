...
export default function MessageBubble({ message }: MessageBubbleProps) {
  ...
  const bodyHtml = highlightAnswerHtml(parsed.body);
        ...
        <div className="flex flex-col gap-sm">
          ...
          {sourceUrl && (
            <a
              ...
              className="inline-flex w-fit items-center gap-xs font-mono text-xs text-primary transition-opacity hover:underline"
            >
