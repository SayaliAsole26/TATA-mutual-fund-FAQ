...
GOLDEN_FACTUAL: tuple[GoldenCase, ...] = (
    ...
    GoldenCase("Expense ratio for Tata Flexi Cap?", "tata-flexi-cap-fund-direct-growth", "tata-flexi-cap", ("0.99%",)),
    ...
    GoldenCase("What is the expense ratio for Tata Floater Fund?", "tata-floater-fund-direct-growth", "tata-floater", ("0.33%",)),
    GoldenCase("What is the expense ratio for Tata Ultra Short Term Fund?", "tata-ultra-short-term-fund-direct-growth", "tata-ultra-short-term", ("0.45%",)),
    ...
    GoldenCase("Expense ratio for Tata Arbitrage Fund?", "tata-arbitrage-fund-direct-growth", "tata-arbitrage", ("1.02%",)),
